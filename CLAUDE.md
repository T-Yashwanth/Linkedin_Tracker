...
Single entry point: `update_tracker.py`. Everything else lives in `linkedin_tracker/` as focused, single-responsibility modules with no shared state beyond what's passed explicitly:
